...
if (isset($saved) || isset($updated) || isset($deleted)) {
    if (isset($saved)) {
        if ($saved) {
            show_success_message('La marca de alimento ha sido creada.');
        } else {
        ...
        if ($updated) {
            show_success_message('La marca de alimento ha sido actualizada.');
        } else {
        ...
        if ($deleted) {
            show_success_message('La marca de alimento ha sido eliminada.');
        } else {
