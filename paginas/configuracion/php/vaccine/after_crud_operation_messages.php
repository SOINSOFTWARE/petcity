...
if (isset($saved) || isset($updated) || isset($deleted)) {
    if (isset($saved)) {
        if ($saved) {
            show_success_message('Un nuevo producto de vacunaci&oacute;n ha sido creado.');
        } else {
        ...
        if ($updated) {
            show_success_message('El producto de vacunaci&oacute;n ha sido actualizado.');
        } else {
        ...
        if ($deleted) {
            show_success_message('El producto de vacunaci&oacute;n ha sido eliminado.');
        } else {
