            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Productos de vacunaci&oacute;n</li>
                    </ol>
                </section>
                	...
                	<div class="row">
						...
						<form method="post" role="form">
	    					<div class="col-xs-5">
				    			<div class="box">
				                    <div class="box-header">
				                        <h3 class="box-title">Nuevo productos de vacunaci&oacute;n</h3>
				                    </div>
				                    <div class="box-body">
				                    	<button type="submit" name="submit" name="submit" class="btn btn-primary">
				                        	<i class="fa fa-save"></i>
				                    	...
				                    	<div class="form-group">
				                            ...
				                            <input type="text" class="form-control" id="name" placeholder="Recombitek, Nobivac, Cepa PV-II..." maxlength="100" required>
				                        </div>
			                    	</div>
		                    	</div>		                    	
							</div>
