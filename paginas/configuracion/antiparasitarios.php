            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Productos antiparasitarios</li>
                    </ol>
                </section>
				    			...
				    			<div class="box">
				                    ...
				                    <div class="box-body">
				                    	...
				                    	<div class="form-group">
				                            ...
				                            <input type="text" class="form-control" id="name" placeholder="Program 400, Advantix, Effitix..." maxlength="100" required>
				                        </div>
			                    	</div>
		                    	</div>		                    	
							</div>
