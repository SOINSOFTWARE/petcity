		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">Reacciones adversas</h3>
				</div>
				<div class="box-body table-responsive">
					<div class="row">
						<div class="col-xs-4">
							<form action="reaccionadversa.php" method="post" role="form">
					...
					<table id="tableData4" class="table table-bordered table-hover">
						<thead>
							<tr>
								<th style="text-align:center; width: 10%">Fecha</th>
								<th style="text-align:center; width: 20%">Tipo de reacci&oacute;n</th>
								<th style="text-align:center; width: 20%">Al&eacute;rgeno</th>
						...
						<tbody>
							...
							while ($rows = mysqli_fetch_array($results)) {
								...
								echo '<td style="text-align:center"><form action="reaccionadversa.php" method="post" role="form"><input type="hidden" id="idclinichistory" name="idclinichistory" value="' . $idclinichistory . '" /><input type="hidden" id="idadversereaction" name="idadversereaction" value="' . $rows["id"] . '" /><button type="submit" id="view" name="view" class="btn btn-warning"><i class="fa fa-folder-open-o"></i></button></form></td>';
								echo '<td style="text-align:center"><form action="historia.php" method="post" role="form"><input type="hidden" id="idclinichistory" name="idclinichistory" value="' . $idclinichistory . '" /><input type="hidden" id="idadversereaction" name="idadversereaction" value="' . $rows["id"] . '" /><button type="submit" id="deleteadvreaction" name="deleteadvreaction" class="btn btn-danger"><i class="fa fa-times"></i></button></form></td>';
								echo "</tr>";
							}
							?>
						</tbody>
