            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Consultas cl&iacute;nicas por mascota</li>
                    </ol>
                </section>
                            	...
                            	<div class="box-body">
                            		<div class="row">
                            			<div class="col-xs-4">
				                            ...
				                            <input type="hidden" id="idpet" value="" />
				                            <input type="text" class="form-control" id="petname" placeholder="Nombre" disabled>
				                        </div>
				                        <div class="col-xs-4">
				                            <label for="ownerdocument">Documento propietario</label>
				                            <input type="text" class="form-control" id="ownerdocument" placeholder="N&uacute;mero de documento" disabled>
				                        </div>
				                        <div class="col-xs-4">
				                            <label for="ownername">Nombre propietario</label>
				                            <input type="text" class="form-control" id="ownername" placeholder="Nombre y apellido" disabled>
				                        </div>
                            		</div>
                        		</div>
                        	</div>
