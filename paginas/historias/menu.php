<ul class="sidebar-menu">
    ...
    <li id="refconfiguration" class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="../configuracion/veterinaria.php"><i class="fa fa-angle-double-right"></i> Datos de la veterinaria</a></li>
            ...
            <li><a href="../configuracion/antiparasitarios.php"><i class="fa fa-angle-double-right"></i> Productos antiparasitarios</a></li>
        </ul>
    </li>
</ul>